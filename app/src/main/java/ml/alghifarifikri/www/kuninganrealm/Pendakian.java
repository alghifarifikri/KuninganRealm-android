...
import static ml.alghifarifikri.www.kuninganrealm.R.string.text_desk5;
...
public class Pendakian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video = (Button) findViewById(R.id.video3);

        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), VideoPendakian.class);
                startActivity(i);
            }
        });

        bt=(Button)findViewById(R.id.share5);
        ...
        String text =  getString(R.string.text_desk5);
