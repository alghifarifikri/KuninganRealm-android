...
import static ml.alghifarifikri.www.kuninganrealm.R.string.text_desk4;
...
public class Fauna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video = (Button) findViewById(R.id.video2);

        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), VideoFauna.class);
                startActivity(i);
            }
        });

        bt=(Button)findViewById(R.id.share4);
        ...
        String text =  getString(R.string.text_desk4);
