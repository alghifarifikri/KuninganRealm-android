...
import static ml.alghifarifikri.www.kuninganrealm.R.string.text_desk6;
...
public class Alam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video = (Button) findViewById(R.id.video4);

        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), VideoAlam.class);
                startActivity(i);
            }
        });

        bt=(Button)findViewById(R.id.share6);
        ...
        String text =  getString(R.string.text_desk6);
