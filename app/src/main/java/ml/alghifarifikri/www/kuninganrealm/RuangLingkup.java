...
import static ml.alghifarifikri.www.kuninganrealm.R.string.text_desk9;

public class RuangLingkup extends AppCompatActivity {
    Button bt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt=(Button)findViewById(R.id.share9);
        ...
        String text =  getString(R.string.text_desk9);
